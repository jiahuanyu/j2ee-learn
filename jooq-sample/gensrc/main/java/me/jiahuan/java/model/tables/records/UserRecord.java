...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record3<Long, String, Gender> {

    private static final long serialVersionUID = -71588284;
     ...
     */
    @Override
    public Row3<Long, String, Gender> fieldsRow() {
     ...
     */
    @Override
    public Row3<Long, String, Gender> valuesRow() {
     ...
     */
    @Override
    public UserRecord values(Long value1, String value2, Gender value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public UserRecord(Long uid, String name, Gender gender) {
        super(User.USER);
